                ...
                var n, o = this,
                    ...
                    u = function () {
                        ...
                        layui.each(a, function (e, a) {
                            ...
                            layui.each(l.data, function (e, t) { t = "function" == typeof t ? t() : t, r.append(e, t) }),
                                r.append(l.field, a),
                                i.ajax({
                                    url: l.url + '?_token=' + top.Comm.db('_token'),
                                    type: "post",
                                    data: r,
                                    datas: l.data,
                                    contentType: !1,
                    ...
                    y = function () {
                        ...
                        for (var key in o.chooseFiles) {
                            //获取签名
                            i.ajax({
                                url: config.root + '/common/oss/getImgPolicy?_token=' + top.Comm.db('_token') + '&_device=' + 1,
                                type: 'get',
                                dataType: "json",
                                async: false,
                                beforeSend: function (request) {
                                    if (top.Comm.db("_token"))
                                        request.setRequestHeader("x-Agent", top.Comm.db('_token'));
                                },
                                success: function (d) {
                                    var t = {
                                        'name': '',
                                    ...
                                    //上传loading
                                    var othis = l;
                                    t.key = d.data.dir + '/pc' + random_string(10) + "." + o.chooseFiles[key].name.split(".")[1];
